...
/**
 * MapScreen component - Shows skateboarding spots on a map
 * Placeholder version until map functionality is implemented
 */
    ...
    <View style={[styles.container, dynamicStyles.container]}>
      <View style={[styles.card, dynamicStyles.card]}>
        ...
        <Text style={[styles.subText, dynamicStyles.subText]}>
          Find the best places to skate near you
        </Text>
      </View>
    </View>
  );
